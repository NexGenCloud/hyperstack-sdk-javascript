...
export default class SnapshotsApi {
    ...
    */
     ...
     */
    createAnImageFromASnapshotWithHttpInfo(snapshotId, payload) {
     ...
     */
    createAnImageFromASnapshot(snapshotId, payload) {
      return this.createAnImageFromASnapshotWithHttpInfo(snapshotId, payload)
     ...
     */
    retrieveASnapshotWithHttpInfo(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     */
    retrieveASnapshot(id) {
      return this.retrieveASnapshotWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    retrieveListOfSnapshotsWithPaginationWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    retrieveListOfSnapshotsWithPagination(opts) {
      return this.retrieveListOfSnapshotsWithPaginationWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
