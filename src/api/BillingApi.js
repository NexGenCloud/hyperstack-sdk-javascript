...
export default class BillingApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/TokenBasedBillingHistoryResponse} and HTTP response
     */
    getImageGenerationBillingHistoryWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = TokenBasedBillingHistoryResponse;
      return this.apiClient.callApi(
        '/billing/billing/history/image_generation', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/TokenBasedBillingHistoryResponse}
     */
    getImageGenerationBillingHistory(opts) {
      return this.getImageGenerationBillingHistoryWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    getImageGenerationBillingHistoryGraphWithHttpInfo(resourceId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceId' is set
      if (resourceId === undefined || resourceId === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ImageGenerationBillingHistoryDetailsResponseSchema;
      return this.apiClient.callApi(
        '/billing/billing/history/image_generation/{resource_id}/graph', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    getImageGenerationBillingHistoryGraph(resourceId, opts) {
      return this.getImageGenerationBillingHistoryGraphWithHttpInfo(resourceId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageGenerationBillingHistoryDetailsResponseSchema} and HTTP response
     */
    getImageGenerationHistoryForResourceWithHttpInfo(resourceId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceId' is set
      if (resourceId === undefined || resourceId === null) {
      ...
      let returnType = ImageGenerationBillingHistoryDetailsResponseSchema;
      return this.apiClient.callApi(
        '/billing/billing/history/image_generation/{resource_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ImageGenerationBillingHistoryDetailsResponseSchema}
     */
    getImageGenerationHistoryForResource(resourceId, opts) {
      return this.getImageGenerationHistoryForResourceWithHttpInfo(resourceId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
