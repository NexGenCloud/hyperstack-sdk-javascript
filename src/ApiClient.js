...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://infrahub-api.nexgencloud.com/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            'apiKey': {type: 'apiKey', 'in': 'header', name: 'api_key'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1.42.0-alpha/Javascript'
        };
