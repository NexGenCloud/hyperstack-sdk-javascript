...
class BillingHistoryServerlessInferenceDetails {
    /**
     * Constructs a new <code>BillingHistoryServerlessInferenceDetails</code>.
    ...
    /**
     * Constructs a <code>BillingHistoryServerlessInferenceDetails</code> from a plain JavaScript object, optionally creating a new instance.
     ...
     * @return {module:model/BillingHistoryServerlessInferenceDetails} The populated <code>BillingHistoryServerlessInferenceDetails</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>BillingHistoryServerlessInferenceDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BillingHistoryServerlessInferenceDetails</code>.
     */
