...
class BillingHistoryFineTuning {
    /**
     * Constructs a new <code>BillingHistoryFineTuning</code>.
    ...
    /**
     * Constructs a <code>BillingHistoryFineTuning</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BillingHistoryFineTuning} obj Optional instance to populate.
     * @return {module:model/BillingHistoryFineTuning} The populated <code>BillingHistoryFineTuning</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>BillingHistoryFineTuning</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BillingHistoryFineTuning</code>.
     */
