...
class CreateUpdatePolicyResponseModel {
    /**
     * Constructs a new <code>CreateUpdatePolicyResponseModel</code>.
    ...
    /**
     * Constructs a <code>CreateUpdatePolicyResponseModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUpdatePolicyResponseModel} obj Optional instance to populate.
     * @return {module:model/CreateUpdatePolicyResponseModel} The populated <code>CreateUpdatePolicyResponseModel</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUpdatePolicyResponseModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUpdatePolicyResponseModel</code>.
     */
