...
class FirewallRule {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('firewall_rule')) {
                obj['firewall_rule'] = SecurityGroupRuleFields.constructFromObject(data['firewall_rule']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['firewall_rule']) { // data not null
          SecurityGroupRuleFields.validateJSON(data['firewall_rule']);
        }
