...
import SnapshotRetrieveFields from './SnapshotRetrieveFields';
...
class SnapshotRetrieve {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('snapshot')) {
                obj['snapshot'] = SnapshotRetrieveFields.constructFromObject(data['snapshot']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['snapshot']) { // data not null
          SnapshotRetrieveFields.validateJSON(data['snapshot']);
        }
...
export default SnapshotRetrieve;
