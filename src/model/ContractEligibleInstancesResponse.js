...
class ContractEligibleInstancesResponse {
    /**
     * Constructs a new <code>ContractEligibleInstancesResponse</code>.
    ...
    /**
     * Constructs a <code>ContractEligibleInstancesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     ...
     * @return {module:model/ContractEligibleInstancesResponse} The populated <code>ContractEligibleInstancesResponse</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ContractEligibleInstancesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContractEligibleInstancesResponse</code>.
     */
...
/**
 * @member {Array.<module:model/ContractEligibleInstanceFields>} instances
 */
