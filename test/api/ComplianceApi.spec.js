...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ComplianceApi();
  });
  ...
  describe('ComplianceApi', function() {
    describe('createCompliance', function() {
      it('should call createCompliance successfully', function(done) {
        //uncomment below and update the code to test createCompliance
        //instance.createCompliance(function(error) {
