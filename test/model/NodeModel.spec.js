...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.NodeModel();
  });
  ...
  describe('NodeModel', function() {
    it('should create an instance of NodeModel', function() {
      // uncomment below and update the code to test NodeModel
      //var instance = new HyperstackApi.NodeModel();
      //expect(instance).to.be.a(HyperstackApi.NodeModel);
    });
