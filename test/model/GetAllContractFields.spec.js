...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.GetAllContractFields();
  });
  ...
  describe('GetAllContractFields', function() {
    it('should create an instance of GetAllContractFields', function() {
      // uncomment below and update the code to test GetAllContractFields
      //var instance = new HyperstackApi.GetAllContractFields();
      //expect(instance).to.be.a(HyperstackApi.GetAllContractFields);
    });
