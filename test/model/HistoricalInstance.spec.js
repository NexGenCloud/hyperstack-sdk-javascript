...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.HistoricalInstance();
  });
  ...
  describe('HistoricalInstance', function() {
    it('should create an instance of HistoricalInstance', function() {
      // uncomment below and update the code to test HistoricalInstance
      //var instance = new HyperstackApi.HistoricalInstance();
      //expect(instance).to.be.a(HyperstackApi.HistoricalInstance);
    });
