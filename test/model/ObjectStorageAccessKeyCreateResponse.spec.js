...
(function(root, factory) {
  ...
  describe('ObjectStorageAccessKeyCreateResponse', function() {
    it('should create an instance of ObjectStorageAccessKeyCreateResponse', function() {
      // uncomment below and update the code to test ObjectStorageAccessKeyCreateResponse
