...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.PolicyPermissionFields();
  });
  ...
  describe('PolicyPermissionFields', function() {
    it('should create an instance of PolicyPermissionFields', function() {
      // uncomment below and update the code to test PolicyPermissionFields
      //var instance = new HyperstackApi.PolicyPermissionFields();
      //expect(instance).to.be.a(HyperstackApi.PolicyPermissionFields);
    });
