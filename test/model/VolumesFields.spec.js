...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.VolumesFields();
  });
  ...
  describe('VolumesFields', function() {
    it('should create an instance of VolumesFields', function() {
      // uncomment below and update the code to test VolumesFields
      //var instance = new HyperstackApi.VolumesFields();
      //expect(instance).to.be.a(HyperstackApi.VolumesFields);
    });
