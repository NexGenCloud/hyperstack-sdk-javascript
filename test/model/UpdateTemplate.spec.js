...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.UpdateTemplate();
  });
  ...
  describe('UpdateTemplate', function() {
    it('should create an instance of UpdateTemplate', function() {
      // uncomment below and update the code to test UpdateTemplate
      //var instance = new HyperstackApi.UpdateTemplate();
      //expect(instance).to.be.a(HyperstackApi.UpdateTemplate);
    });
