...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ContractResourcePayload();
  });
  ...
  describe('ContractResourcePayload', function() {
    it('should create an instance of ContractResourcePayload', function() {
      // uncomment below and update the code to test ContractResourcePayload
      //var instance = new HyperstackApi.ContractResourcePayload();
      //expect(instance).to.be.a(HyperstackApi.ContractResourcePayload);
    });
