...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CreateUpdatePolicyPayload();
  });
  ...
  describe('CreateUpdatePolicyPayload', function() {
    it('should create an instance of CreateUpdatePolicyPayload', function() {
      // uncomment below and update the code to test CreateUpdatePolicyPayload
