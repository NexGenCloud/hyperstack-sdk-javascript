...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.UpdateVolumePayload();
  });
  ...
  describe('UpdateVolumePayload', function() {
    it('should create an instance of UpdateVolumePayload', function() {
      // uncomment below and update the code to test UpdateVolumePayload
      //var instance = new HyperstackApi.UpdateVolumePayload();
