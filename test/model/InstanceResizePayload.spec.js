...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.InstanceResizePayload();
  });
  ...
  describe('InstanceResizePayload', function() {
    it('should create an instance of InstanceResizePayload', function() {
      // uncomment below and update the code to test InstanceResizePayload
      //var instance = new HyperstackApi.InstanceResizePayload();
      //expect(instance).to.be.a(HyperstackApi.InstanceResizePayload);
    });
