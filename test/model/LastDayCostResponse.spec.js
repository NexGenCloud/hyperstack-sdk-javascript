...
(function(root, factory) {
  ...
  describe('LastDayCostResponse', function() {
    it('should create an instance of LastDayCostResponse', function() {
      // uncomment below and update the code to test LastDayCostResponse
