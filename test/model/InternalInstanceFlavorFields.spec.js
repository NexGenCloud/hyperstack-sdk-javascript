...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.InternalInstanceFlavorFields();
  });
  ...
  describe('InternalInstanceFlavorFields', function() {
    it('should create an instance of InternalInstanceFlavorFields', function() {
      // uncomment below and update the code to test InternalInstanceFlavorFields
