...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ContractBillingHistoryResponseAttributes();
  });
  ...
  describe('ContractBillingHistoryResponseAttributes', function() {
    it('should create an instance of ContractBillingHistoryResponseAttributes', function() {
      // uncomment below and update the code to test ContractBillingHistoryResponseAttributes
    ...
    it('should have the property gpuName (base name: "gpu_name")', function() {
      // uncomment below and update the code to test the property gpuName
      //var instance = new HyperstackApi.ContractBillingHistoryResponseAttributes();
      //expect(instance).to.be();
    });
