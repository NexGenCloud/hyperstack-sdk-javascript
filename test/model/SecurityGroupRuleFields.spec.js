...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.SecurityGroupRuleFields();
  });
  ...
  describe('SecurityGroupRuleFields', function() {
    it('should create an instance of SecurityGroupRuleFields', function() {
      // uncomment below and update the code to test SecurityGroupRuleFields
      //var instance = new HyperstackApi.SecurityGroupRuleFields();
      //expect(instance).to.be.a(HyperstackApi.SecurityGroupRuleFields);
    });
