...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CreateClusterNodeGroupPayload();
  });
  ...
  describe('CreateClusterNodeGroupPayload', function() {
    it('should create an instance of CreateClusterNodeGroupPayload', function() {
      // uncomment below and update the code to test CreateClusterNodeGroupPayload
      //var instance = new HyperstackApi.CreateClusterNodeGroupPayload();
      //expect(instance).to.be.a(HyperstackApi.CreateClusterNodeGroupPayload);
    });
