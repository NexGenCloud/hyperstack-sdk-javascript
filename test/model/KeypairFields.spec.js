...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.KeypairFields();
  });
  ...
  describe('KeypairFields', function() {
    it('should create an instance of KeypairFields', function() {
      // uncomment below and update the code to test KeypairFields
      //var instance = new HyperstackApi.KeypairFields();
      //expect(instance).to.be.a(HyperstackApi.KeypairFields);
    });
