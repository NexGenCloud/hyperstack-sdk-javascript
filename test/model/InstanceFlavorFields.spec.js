...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.InstanceFlavorFields();
  });
  ...
  describe('InstanceFlavorFields', function() {
    it('should create an instance of InstanceFlavorFields', function() {
      // uncomment below and update the code to test InstanceFlavorFields
      //var instance = new HyperstackApi.InstanceFlavorFields();
      //expect(instance).to.be.a(HyperstackApi.InstanceFlavorFields);
    });
