...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CreateUpdatePermissionResponseModel();
  });
  ...
  describe('CreateUpdatePermissionResponseModel', function() {
    it('should create an instance of CreateUpdatePermissionResponseModel', function() {
      // uncomment below and update the code to test CreateUpdatePermissionResponseModel
