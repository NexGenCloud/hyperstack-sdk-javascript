...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.FlavorPayload();
  });
  ...
  describe('FlavorPayload', function() {
    it('should create an instance of FlavorPayload', function() {
      // uncomment below and update the code to test FlavorPayload
      //var instance = new HyperstackApi.FlavorPayload();
      //expect(instance).to.be.a(HyperstackApi.FlavorPayload);
    });
