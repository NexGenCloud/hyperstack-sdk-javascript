...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CreateClusterNodeFields();
  });
  ...
  describe('CreateClusterNodeFields', function() {
    it('should create an instance of CreateClusterNodeFields', function() {
      // uncomment below and update the code to test CreateClusterNodeFields
