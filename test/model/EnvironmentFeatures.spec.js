...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.EnvironmentFeatures();
  });
  ...
  describe('EnvironmentFeatures', function() {
    it('should create an instance of EnvironmentFeatures', function() {
      // uncomment below and update the code to test EnvironmentFeatures
