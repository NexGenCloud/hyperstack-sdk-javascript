...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.SecondaryColor();
  });
  ...
  describe('SecondaryColor', function() {
    it('should create an instance of SecondaryColor', function() {
      // uncomment below and update the code to test SecondaryColor
      //var instance = new HyperstackApi.SecondaryColor();
      //expect(instance).to.be.a(HyperstackApi.SecondaryColor);
    });
