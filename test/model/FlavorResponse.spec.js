...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.FlavorResponse();
  });
  ...
  describe('FlavorResponse', function() {
    it('should create an instance of FlavorResponse', function() {
      // uncomment below and update the code to test FlavorResponse
      //var instance = new HyperstackApi.FlavorResponse();
