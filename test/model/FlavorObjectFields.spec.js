...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.FlavorObjectFields();
  });
  ...
  describe('FlavorObjectFields', function() {
    it('should create an instance of FlavorObjectFields', function() {
      // uncomment below and update the code to test FlavorObjectFields
      //var instance = new HyperstackApi.FlavorObjectFields();
      //expect(instance).to.be.a(HyperstackApi.FlavorObjectFields);
    });
