...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.OverviewInfo();
  });
  ...
  describe('OverviewInfo', function() {
    it('should create an instance of OverviewInfo', function() {
      // uncomment below and update the code to test OverviewInfo
