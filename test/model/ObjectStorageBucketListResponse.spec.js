...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ObjectStorageBucketListResponse();
  });
  ...
  describe('ObjectStorageBucketListResponse', function() {
    it('should create an instance of ObjectStorageBucketListResponse', function() {
      ...
      //expect(instance).to.be.a(HyperstackApi.ObjectStorageBucketListResponse);
    });
