...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.InternalSecurityRulesFieldsForInstance();
  });
  ...
  describe('InternalSecurityRulesFieldsForInstance', function() {
    it('should create an instance of InternalSecurityRulesFieldsForInstance', function() {
      // uncomment below and update the code to test InternalSecurityRulesFieldsForInstance
      //var instance = new HyperstackApi.InternalSecurityRulesFieldsForInstance();
      //expect(instance).to.be.a(HyperstackApi.InternalSecurityRulesFieldsForInstance);
    });
