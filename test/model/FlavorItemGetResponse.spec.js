...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.FlavorItemGetResponse();
  });
  ...
  describe('FlavorItemGetResponse', function() {
    it('should create an instance of FlavorItemGetResponse', function() {
      // uncomment below and update the code to test FlavorItemGetResponse
      //var instance = new HyperstackApi.FlavorItemGetResponse();
      //expect(instance).to.be.a(HyperstackApi.FlavorItemGetResponse);
    });
