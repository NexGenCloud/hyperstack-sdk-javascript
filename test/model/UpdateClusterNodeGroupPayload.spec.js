...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.UpdateClusterNodeGroupPayload();
  });
  ...
  describe('UpdateClusterNodeGroupPayload', function() {
    it('should create an instance of UpdateClusterNodeGroupPayload', function() {
      // uncomment below and update the code to test UpdateClusterNodeGroupPayload
