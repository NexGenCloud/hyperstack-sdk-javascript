...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.Attributes();
  });
  ...
  describe('Attributes', function() {
    it('should create an instance of Attributes', function() {
      ...
      //var instance = new HyperstackApi.Attributes();
      //expect(instance).to.be.a(HyperstackApi.Attributes);
    });
    ...
    it('should have the property baseModelDisplayName (base name: "base_model_display_name")', function() {
      // uncomment below and update the code to test the property baseModelDisplayName
      //var instance = new HyperstackApi.Attributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property loraAdapter (base name: "lora_adapter")', function() {
      // uncomment below and update the code to test the property loraAdapter
      //var instance = new HyperstackApi.Attributes();
      //expect(instance).to.be();
    });
