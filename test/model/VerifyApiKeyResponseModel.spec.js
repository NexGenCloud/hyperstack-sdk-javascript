...
(function(root, factory) {
  ...
  describe('VerifyApiKeyResponseModel', function() {
    it('should create an instance of VerifyApiKeyResponseModel', function() {
      // uncomment below and update the code to test VerifyApiKeyResponseModel
      //var instance = new HyperstackApi.VerifyApiKeyResponseModel();
