...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ResourceLevelBillingHistoryResponseMetrics();
  });
  ...
  describe('ResourceLevelBillingHistoryResponseMetrics', function() {
    it('should create an instance of ResourceLevelBillingHistoryResponseMetrics', function() {
      // uncomment below and update the code to test ResourceLevelBillingHistoryResponseMetrics
      //var instance = new HyperstackApi.ResourceLevelBillingHistoryResponseMetrics();
      //expect(instance).to.be.a(HyperstackApi.ResourceLevelBillingHistoryResponseMetrics);
    });
