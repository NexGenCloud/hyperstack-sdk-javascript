...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.SnapshotFields();
  });
  ...
  describe('SnapshotFields', function() {
    it('should create an instance of SnapshotFields', function() {
      // uncomment below and update the code to test SnapshotFields
