...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CustomerContractFields();
  });
  ...
  describe('CustomerContractFields', function() {
    it('should create an instance of CustomerContractFields', function() {
      // uncomment below and update the code to test CustomerContractFields
      //var instance = new HyperstackApi.CustomerContractFields();
      //expect(instance).to.be.a(HyperstackApi.CustomerContractFields);
    });
