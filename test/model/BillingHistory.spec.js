...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.BillingHistory();
  });
  ...
  describe('BillingHistory', function() {
    it('should create an instance of BillingHistory', function() {
      // uncomment below and update the code to test BillingHistory
      //var instance = new HyperstackApi.BillingHistory();
      //expect(instance).to.be.a(HyperstackApi.BillingHistory);
    });
