...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CreateVolumePayload();
  });
  ...
  describe('CreateVolumePayload', function() {
    it('should create an instance of CreateVolumePayload', function() {
      // uncomment below and update the code to test CreateVolumePayload
      //var instance = new HyperstackApi.CreateVolumePayload();
      //expect(instance).to.be.a(HyperstackApi.CreateVolumePayload);
    });
