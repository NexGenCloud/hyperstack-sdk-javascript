...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.KeypairEnvironmentFeatures();
  });
  ...
  describe('KeypairEnvironmentFeatures', function() {
    it('should create an instance of KeypairEnvironmentFeatures', function() {
      // uncomment below and update the code to test KeypairEnvironmentFeatures
      //var instance = new HyperstackApi.KeypairEnvironmentFeatures();
      //expect(instance).to.be.a(HyperstackApi.KeypairEnvironmentFeatures);
    });
