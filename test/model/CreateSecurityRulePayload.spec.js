...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CreateSecurityRulePayload();
  });
  ...
  describe('CreateSecurityRulePayload', function() {
    it('should create an instance of CreateSecurityRulePayload', function() {
      // uncomment below and update the code to test CreateSecurityRulePayload
      //var instance = new HyperstackApi.CreateSecurityRulePayload();
      //expect(instance).to.be.a(HyperstackApi.CreateSecurityRulePayload);
    });
