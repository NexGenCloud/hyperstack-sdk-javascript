...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.Snapshots();
  });
  ...
  describe('Snapshots', function() {
    it('should create an instance of Snapshots', function() {
      // uncomment below and update the code to test Snapshots
      //var instance = new HyperstackApi.Snapshots();
      //expect(instance).to.be.a(HyperstackApi.Snapshots);
    });
