...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ClusterEventsFields();
  });
  ...
  describe('ClusterEventsFields', function() {
    it('should create an instance of ClusterEventsFields', function() {
      // uncomment below and update the code to test ClusterEventsFields
      //var instance = new HyperstackApi.ClusterEventsFields();
      //expect(instance).to.be.a(HyperstackApi.ClusterEventsFields);
    });
