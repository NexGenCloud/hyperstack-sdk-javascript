...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.FutureNodeModel();
  });
  ...
  describe('FutureNodeModel', function() {
    it('should create an instance of FutureNodeModel', function() {
      // uncomment below and update the code to test FutureNodeModel
      //var instance = new HyperstackApi.FutureNodeModel();
      //expect(instance).to.be.a(HyperstackApi.FutureNodeModel);
    });
