...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.DiscountResourceFields();
  });
  ...
  describe('DiscountResourceFields', function() {
    it('should create an instance of DiscountResourceFields', function() {
      // uncomment below and update the code to test DiscountResourceFields
      //var instance = new HyperstackApi.DiscountResourceFields();
      //expect(instance).to.be.a(HyperstackApi.DiscountResourceFields);
    });
