...
(function(root, factory) {
  ...
  describe('GetAllContractsResponseModel', function() {
    it('should create an instance of GetAllContractsResponseModel', function() {
      // uncomment below and update the code to test GetAllContractsResponseModel
      //var instance = new HyperstackApi.GetAllContractsResponseModel();
