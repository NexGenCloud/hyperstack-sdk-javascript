...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.VolumeAttachmentFields();
  });
  ...
  describe('VolumeAttachmentFields', function() {
    it('should create an instance of VolumeAttachmentFields', function() {
      // uncomment below and update the code to test VolumeAttachmentFields
      //var instance = new HyperstackApi.VolumeAttachmentFields();
      //expect(instance).to.be.a(HyperstackApi.VolumeAttachmentFields);
    });
