...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.RolePermissionFields();
  });
  ...
  describe('RolePermissionFields', function() {
    it('should create an instance of RolePermissionFields', function() {
      // uncomment below and update the code to test RolePermissionFields
      //var instance = new HyperstackApi.RolePermissionFields();
      //expect(instance).to.be.a(HyperstackApi.RolePermissionFields);
    });
