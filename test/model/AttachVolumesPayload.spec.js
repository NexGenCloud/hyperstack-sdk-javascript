...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.AttachVolumesPayload();
  });
  ...
  describe('AttachVolumesPayload', function() {
    it('should create an instance of AttachVolumesPayload', function() {
      // uncomment below and update the code to test AttachVolumesPayload
