...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.OrganizationObjectResponse();
  });
  ...
  describe('OrganizationObjectResponse', function() {
    it('should create an instance of OrganizationObjectResponse', function() {
      // uncomment below and update the code to test OrganizationObjectResponse
