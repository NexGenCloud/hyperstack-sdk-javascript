...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ExcludeBillingPostPayload();
  });
  ...
  describe('ExcludeBillingPostPayload', function() {
    it('should create an instance of ExcludeBillingPostPayload', function() {
      // uncomment below and update the code to test ExcludeBillingPostPayload
      //var instance = new HyperstackApi.ExcludeBillingPostPayload();
      //expect(instance).to.be.a(HyperstackApi.ExcludeBillingPostPayload);
    });
