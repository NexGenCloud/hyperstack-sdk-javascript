...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ClusterFlavorFields();
  });
  ...
  describe('ClusterFlavorFields', function() {
    it('should create an instance of ClusterFlavorFields', function() {
      // uncomment below and update the code to test ClusterFlavorFields
      //var instance = new HyperstackApi.ClusterFlavorFields();
      //expect(instance).to.be.a(HyperstackApi.ClusterFlavorFields);
    });
