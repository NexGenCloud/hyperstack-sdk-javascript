...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ImportKeypairPayload();
  });
  ...
  describe('ImportKeypairPayload', function() {
    it('should create an instance of ImportKeypairPayload', function() {
      // uncomment below and update the code to test ImportKeypairPayload
      //var instance = new HyperstackApi.ImportKeypairPayload();
      //expect(instance).to.be.a(HyperstackApi.ImportKeypairPayload);
    });
