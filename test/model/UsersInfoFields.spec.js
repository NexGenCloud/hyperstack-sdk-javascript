...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.UsersInfoFields();
  });
  ...
  describe('UsersInfoFields', function() {
    it('should create an instance of UsersInfoFields', function() {
      // uncomment below and update the code to test UsersInfoFields
      //var instance = new HyperstackApi.UsersInfoFields();
      //expect(instance).to.be.a(HyperstackApi.UsersInfoFields);
    });
