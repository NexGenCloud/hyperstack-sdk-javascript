...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ResourceLevelBillingHistoryResourcesCluster();
  });
  ...
  describe('ResourceLevelBillingHistoryResourcesCluster', function() {
    it('should create an instance of ResourceLevelBillingHistoryResourcesCluster', function() {
      // uncomment below and update the code to test ResourceLevelBillingHistoryResourcesCluster
