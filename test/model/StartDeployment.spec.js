...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.StartDeployment();
  });
  ...
  describe('StartDeployment', function() {
    it('should create an instance of StartDeployment', function() {
      // uncomment below and update the code to test StartDeployment
      //var instance = new HyperstackApi.StartDeployment();
      //expect(instance).to.be.a(HyperstackApi.StartDeployment);
    });
