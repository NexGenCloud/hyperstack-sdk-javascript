...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.FutureNodeStockModel();
  });
  ...
  describe('FutureNodeStockModel', function() {
    it('should create an instance of FutureNodeStockModel', function() {
      // uncomment below and update the code to test FutureNodeStockModel
      //var instance = new HyperstackApi.FutureNodeStockModel();
