...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.CompatibleImage();
  });
  ...
  describe('CompatibleImage', function() {
    it('should create an instance of CompatibleImage', function() {
      // uncomment below and update the code to test CompatibleImage
      //var instance = new HyperstackApi.CompatibleImage();
      //expect(instance).to.be.a(HyperstackApi.CompatibleImage);
    });
