...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ContractEligibleInstancesResponse();
  });
  ...
  describe('ContractEligibleInstancesResponse', function() {
    it('should create an instance of ContractEligibleInstancesResponse', function() {
      // uncomment below and update the code to test ContractEligibleInstancesResponse
