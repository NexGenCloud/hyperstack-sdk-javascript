...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.Creditrequests();
  });
  ...
  describe('Creditrequests', function() {
    it('should create an instance of Creditrequests', function() {
      // uncomment below and update the code to test Creditrequests
