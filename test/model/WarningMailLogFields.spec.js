...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.WarningMailLogFields();
  });
  ...
  describe('WarningMailLogFields', function() {
    it('should create an instance of WarningMailLogFields', function() {
      // uncomment below and update the code to test WarningMailLogFields
      //var instance = new HyperstackApi.WarningMailLogFields();
      //expect(instance).to.be.a(HyperstackApi.WarningMailLogFields);
    });
