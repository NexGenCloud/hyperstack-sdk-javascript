...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.SecurityRulesFieldsforInstance();
  });
  ...
  describe('SecurityRulesFieldsforInstance', function() {
    it('should create an instance of SecurityRulesFieldsforInstance', function() {
      // uncomment below and update the code to test SecurityRulesFieldsforInstance
      //var instance = new HyperstackApi.SecurityRulesFieldsforInstance();
      //expect(instance).to.be.a(HyperstackApi.SecurityRulesFieldsforInstance);
    });
