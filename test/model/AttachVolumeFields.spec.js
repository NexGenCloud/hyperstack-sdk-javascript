...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.AttachVolumeFields();
  });
  ...
  describe('AttachVolumeFields', function() {
    it('should create an instance of AttachVolumeFields', function() {
      // uncomment below and update the code to test AttachVolumeFields
      //var instance = new HyperstackApi.AttachVolumeFields();
      //expect(instance).to.be.a(HyperstackApi.AttachVolumeFields);
    });
