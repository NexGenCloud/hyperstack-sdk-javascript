...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ApiKeyVerifyFields();
  });
  ...
  describe('ApiKeyVerifyFields', function() {
    it('should create an instance of ApiKeyVerifyFields', function() {
      // uncomment below and update the code to test ApiKeyVerifyFields
      //var instance = new HyperstackApi.ApiKeyVerifyFields();
      //expect(instance).to.be.a(HyperstackApi.ApiKeyVerifyFields);
    });
