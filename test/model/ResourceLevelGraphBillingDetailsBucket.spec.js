...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ResourceLevelGraphBillingDetailsBucket();
  });
  ...
  describe('ResourceLevelGraphBillingDetailsBucket', function() {
    it('should create an instance of ResourceLevelGraphBillingDetailsBucket', function() {
      // uncomment below and update the code to test ResourceLevelGraphBillingDetailsBucket
      //var instance = new HyperstackApi.ResourceLevelGraphBillingDetailsBucket();
