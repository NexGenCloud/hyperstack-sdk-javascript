...
(function(root, factory) {
  ...
  describe('ObjectStorageAccessKeyResponse', function() {
    it('should create an instance of ObjectStorageAccessKeyResponse', function() {
      // uncomment below and update the code to test ObjectStorageAccessKeyResponse
