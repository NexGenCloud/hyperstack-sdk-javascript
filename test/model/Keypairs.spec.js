...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.Keypairs();
  });
  ...
  describe('Keypairs', function() {
    it('should create an instance of Keypairs', function() {
      // uncomment below and update the code to test Keypairs
      //var instance = new HyperstackApi.Keypairs();
      //expect(instance).to.be.a(HyperstackApi.Keypairs);
    });
