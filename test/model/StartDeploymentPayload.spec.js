...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.StartDeploymentPayload();
  });
  ...
  describe('StartDeploymentPayload', function() {
    it('should create an instance of StartDeploymentPayload', function() {
      // uncomment below and update the code to test StartDeploymentPayload
      //var instance = new HyperstackApi.StartDeploymentPayload();
      //expect(instance).to.be.a(HyperstackApi.StartDeploymentPayload);
    });
