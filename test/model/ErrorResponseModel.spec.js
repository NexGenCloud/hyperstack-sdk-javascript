...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.ErrorResponseModel();
  });
  ...
  describe('ErrorResponseModel', function() {
    it('should create an instance of ErrorResponseModel', function() {
      ...
      //var instance = new HyperstackApi.ErrorResponseModel();
      //expect(instance).to.be.a(HyperstackApi.ErrorResponseModel);
    });
