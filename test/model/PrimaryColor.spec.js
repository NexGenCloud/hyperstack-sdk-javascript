...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.PrimaryColor();
  });
  ...
  describe('PrimaryColor', function() {
    it('should create an instance of PrimaryColor', function() {
      // uncomment below and update the code to test PrimaryColor
      //var instance = new HyperstackApi.PrimaryColor();
      //expect(instance).to.be.a(HyperstackApi.PrimaryColor);
    });
