...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.RegionFields();
  });
  ...
  describe('RegionFields', function() {
    it('should create an instance of RegionFields', function() {
      // uncomment below and update the code to test RegionFields
