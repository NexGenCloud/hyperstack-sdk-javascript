...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperstackApi.InternalInstanceFields();
  });
  ...
  describe('InternalInstanceFields', function() {
    it('should create an instance of InternalInstanceFields', function() {
      // uncomment below and update the code to test InternalInstanceFields
      //var instance = new HyperstackApi.InternalInstanceFields();
      //expect(instance).to.be.a(HyperstackApi.InternalInstanceFields);
    });

    it('should have the property bootSource (base name: "boot_source")', function() {
      // uncomment below and update the code to test the property bootSource
      //var instance = new HyperstackApi.InternalInstanceFields();
