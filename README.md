...
*HyperstackApi.UserConsentApi* | [**getAllConsentTemplates**](docs/UserConsentApi.md#getAllConsentTemplates) | **GET** /auth/user-consent/templates | Get all consent templates
*HyperstackApi.UserConsentApi* | [**getAllConsentsForAUser**](docs/UserConsentApi.md#getAllConsentsForAUser) | **GET** /auth/user-consent | Get Consents for a User
*HyperstackApi.UserConsentApi* | [**getConsentTemplateByType**](docs/UserConsentApi.md#getConsentTemplateByType) | **GET** /auth/user-consent/templates/{consent_type} | Get consent template for a specific type
*HyperstackApi.UserConsentApi* | [**updateAConsentActionByType**](docs/UserConsentApi.md#updateAConsentActionByType) | **PATCH** /auth/user-consent/{consent_type} | Grant or revoke an existing consent
*HyperstackApi.UserConsentEventsApi* | [**getConsentAuditEvents**](docs/UserConsentEventsApi.md#getConsentAuditEvents) | **GET** /auth/user-consent-events/{consent_type}/events | Get audit trail for a consent
...
*HyperstackApi.VirtualMachineApi* | [**toggleEnhancedMetricsForAVM**](docs/VirtualMachineApi.md#toggleEnhancedMetricsForAVM) | **PATCH** /core/virtual-machines/{vm_id}/enhanced-metrics | Enable or disable Enhanced Metrics for a virtual machine
...
## Documentation for Models
 ...
 - [HyperstackApi.CompatibleImage](docs/CompatibleImage.md)
 - [HyperstackApi.ConsentActionResponse](docs/ConsentActionResponse.md)
 - [HyperstackApi.ConsentBlock](docs/ConsentBlock.md)
 - [HyperstackApi.ConsentEventsResponse](docs/ConsentEventsResponse.md)
 - [HyperstackApi.ConsentTemplate](docs/ConsentTemplate.md)
 - [HyperstackApi.ConsentTemplatesResponse](docs/ConsentTemplatesResponse.md)
 ...
 - [HyperstackApi.ImageRestrictions](docs/ImageRestrictions.md)
 ...
 - [HyperstackApi.InstanceEnhancedMetricsFields](docs/InstanceEnhancedMetricsFields.md)
 ...
 - [HyperstackApi.RecordConsentRequest](docs/RecordConsentRequest.md)
 ...
 - [HyperstackApi.UserConsent](docs/UserConsent.md)
 - [HyperstackApi.UserConsentEvent](docs/UserConsentEvent.md)
 - [HyperstackApi.UserConsentsResponse](docs/UserConsentsResponse.md)
 ...
 - [HyperstackApi.UserEnhancedMetricsPayload](docs/UserEnhancedMetricsPayload.md)
 - [HyperstackApi.UserEnhancedMetricsResponse](docs/UserEnhancedMetricsResponse.md)
 - [HyperstackApi.UserEnhancedMetricsResponseFields](docs/UserEnhancedMetricsResponseFields.md)
