...
var AliveApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  function AliveApi(apiClient) {
    _classCallCheck(this, AliveApi);
  ...
  return _createClass(AliveApi, [{
    key: "getAliveWithHttpInfo",
    value: function getAliveWithHttpInfo() {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
      ...
      var accepts = [];
      var returnType = null;
      return this.apiClient.callApi('/billing/alive', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
