...
var UserDetailChoiceApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  function UserDetailChoiceApi(apiClient) {
    _classCallCheck(this, UserDetailChoiceApi);
  ...
  return _createClass(UserDetailChoiceApi, [{
    ...
    value: function retrieveDefaultFlavorsAndImagesWithHttpInfo() {
      ...
      return this.apiClient.callApi('/core/user/resources/defaults', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
