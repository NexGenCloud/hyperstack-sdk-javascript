...
var _FlavorItemGetResponse = _interopRequireDefault(require("./FlavorItemGetResponse"));
...
var FlavorListResponse = /*#__PURE__*/function () {
   ...
   */
  function FlavorListResponse() {
    _classCallCheck(this, FlavorListResponse);
   ...
   */
  return _createClass(FlavorListResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_FlavorItemGetResponse["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _FlavorItemGetResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = FlavorListResponse;