...
var AuthRequestLoginResponseModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AuthRequestLoginResponseModel</code>.
  ...
  return _createClass(AuthRequestLoginResponseModel, null, [{
    ...
    /**
     * Constructs a <code>AuthRequestLoginResponseModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthRequestLoginResponseModel} obj Optional instance to populate.
     * @return {module:model/AuthRequestLoginResponseModel} The populated <code>AuthRequestLoginResponseModel</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>AuthRequestLoginResponseModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthRequestLoginResponseModel</code>.
     */
  }, {
    key: "validateJSON",
