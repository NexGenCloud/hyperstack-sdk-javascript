...
var FlavorFields = /*#__PURE__*/function () {
  ...
  function FlavorFields() {
    _classCallCheck(this, FlavorFields);
   ...
   */
  return _createClass(FlavorFields, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('stock_available')) {
          obj['stock_available'] = _ApiClient["default"].convertToType(data['stock_available'], 'Boolean');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = FlavorFields;