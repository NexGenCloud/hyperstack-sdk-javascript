...
var ProfileListResponse = /*#__PURE__*/function () {
   ...
   */
  function ProfileListResponse() {
    _classCallCheck(this, ProfileListResponse);
   ...
   */
  return _createClass(ProfileListResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('profiles')) {
          obj['profiles'] = _ApiClient["default"].convertToType(data['profiles'], [_ProfileFields["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['profiles']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['profiles']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ProfileFields["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ProfileListResponse;