...
var _PaymentDetailsFields = _interopRequireDefault(require("./PaymentDetailsFields"));
...
var PaymentDetailsResponse = /*#__PURE__*/function () {
  ...
  function PaymentDetailsResponse() {
    _classCallCheck(this, PaymentDetailsResponse);
   ...
   */
  return _createClass(PaymentDetailsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_PaymentDetailsFields["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _PaymentDetailsFields["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
 ...
 */
PaymentDetailsResponse.prototype['message'] = undefined;

/**
 * @member {Boolean} status
 */
PaymentDetailsResponse.prototype['status'] = undefined;
var _default = exports["default"] = PaymentDetailsResponse;