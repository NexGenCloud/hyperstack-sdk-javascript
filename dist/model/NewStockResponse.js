...
var _NewModelResponse = _interopRequireDefault(require("./NewModelResponse"));
...
var NewStockResponse = /*#__PURE__*/function () {
   ...
   */
  function NewStockResponse() {
    _classCallCheck(this, NewStockResponse);
   ...
   */
  return _createClass(NewStockResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('models')) {
          obj['models'] = _ApiClient["default"].convertToType(data['models'], [_NewModelResponse["default"]]);
        }
        if (data.hasOwnProperty('region')) {
          obj['region'] = _ApiClient["default"].convertToType(data['region'], 'String');
        }
        if (data.hasOwnProperty('stock-type')) {
          obj['stock-type'] = _ApiClient["default"].convertToType(data['stock-type'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['models']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['models']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _NewModelResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = NewStockResponse;