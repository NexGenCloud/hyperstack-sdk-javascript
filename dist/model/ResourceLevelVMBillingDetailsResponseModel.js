...
var _ResourceLevelBillingDetailsVM = _interopRequireDefault(require("./ResourceLevelBillingDetailsVM"));
...
var ResourceLevelVMBillingDetailsResponseModel = /*#__PURE__*/function () {
   ...
   */
  function ResourceLevelVMBillingDetailsResponseModel() {
    _classCallCheck(this, ResourceLevelVMBillingDetailsResponseModel);
   ...
   */
  return _createClass(ResourceLevelVMBillingDetailsResponseModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('billing_history_vm_details')) {
          obj['billing_history_vm_details'] = _ResourceLevelBillingDetailsVM["default"].constructFromObject(data['billing_history_vm_details']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['billing_history_vm_details']) {
        // data not null
        _ResourceLevelBillingDetailsVM["default"].validateJSON(data['billing_history_vm_details']);
      }
...
var _default = exports["default"] = ResourceLevelVMBillingDetailsResponseModel;