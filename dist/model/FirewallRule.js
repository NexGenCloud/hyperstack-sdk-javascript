...
var FirewallRule = /*#__PURE__*/function () {
  ...
  function FirewallRule() {
    _classCallCheck(this, FirewallRule);
   ...
   */
  return _createClass(FirewallRule, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('firewall_rule')) {
          obj['firewall_rule'] = _SecurityGroupRuleFields["default"].constructFromObject(data['firewall_rule']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['firewall_rule']) {
        // data not null
        _SecurityGroupRuleFields["default"].validateJSON(data['firewall_rule']);
      }
...
/**
 * @member {module:model/SecurityGroupRuleFields} firewall_rule
 */
FirewallRule.prototype['firewall_rule'] = undefined;

/**
 * @member {String} message
 */
FirewallRule.prototype['message'] = undefined;

/**
 * @member {Boolean} status
 */
FirewallRule.prototype['status'] = undefined;
var _default = exports["default"] = FirewallRule;