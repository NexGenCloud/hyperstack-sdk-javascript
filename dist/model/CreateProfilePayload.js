...
var CreateProfilePayload = /*#__PURE__*/function () {
  ...
  function CreateProfilePayload(data, name) {
    _classCallCheck(this, CreateProfilePayload);
   ...
   */
  return _createClass(CreateProfilePayload, null, [{
    key: "initialize",
    value: function initialize(obj, data, name) {
      obj['data'] = data;
      obj['name'] = name;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateProfilePayload.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = CreateProfilePayload;