...
var _ImageGetResponse = _interopRequireDefault(require("./ImageGetResponse"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('images')) {
          obj['images'] = _ApiClient["default"].convertToType(data['images'], [_ImageGetResponse["default"]]);
        }
      ...
      if (data['images']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ImageGetResponse["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
