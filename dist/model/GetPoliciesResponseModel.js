 ...
 */
var GetPoliciesResponseModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetPoliciesResponseModel</code>.
   * @alias module:model/GetPoliciesResponseModel
   */
  function GetPoliciesResponseModel() {
    _classCallCheck(this, GetPoliciesResponseModel);
   ...
   */
  return _createClass(GetPoliciesResponseModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('policies')) {
          obj['policies'] = _ApiClient["default"].convertToType(data['policies'], [_PolicyFields["default"]]);
        }
      ...
      if (data['policies']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _PolicyFields["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = GetPoliciesResponseModel;