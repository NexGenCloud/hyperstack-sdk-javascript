...
var StartDeploymentPayload = /*#__PURE__*/function () {
   ...
   */
  function StartDeploymentPayload(description, name, templateId) {
    _classCallCheck(this, StartDeploymentPayload);
   ...
   */
  return _createClass(StartDeploymentPayload, null, [{
    key: "initialize",
    value: function initialize(obj, description, name, templateId) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(StartDeploymentPayload.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = StartDeploymentPayload;