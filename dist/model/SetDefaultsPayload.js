 ...
 */
var SetDefaultsPayload = /*#__PURE__*/function () {
  /**
   ...
   */
  function SetDefaultsPayload(flavors, images) {
    _classCallCheck(this, SetDefaultsPayload);
   ...
   */
  return _createClass(SetDefaultsPayload, null, [{
    key: "initialize",
    value: function initialize(obj, flavors, images) {
      obj['flavors'] = flavors;
      obj['images'] = images;
    }
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('flavors')) {
          obj['flavors'] = _ApiClient["default"].convertToType(data['flavors'], ['Number']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SetDefaultsPayload.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = SetDefaultsPayload;