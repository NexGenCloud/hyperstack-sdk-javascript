...
var ClusterNodeGroupFirewallFields = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ClusterNodeGroupFirewallFields</code>.
  ...
  return _createClass(ClusterNodeGroupFirewallFields, null, [{
    ...
    /**
     * Constructs a <code>ClusterNodeGroupFirewallFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterNodeGroupFirewallFields} obj Optional instance to populate.
     * @return {module:model/ClusterNodeGroupFirewallFields} The populated <code>ClusterNodeGroupFirewallFields</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterNodeGroupFirewallFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterNodeGroupFirewallFields</code>.
     */
  }, {
    key: "validateJSON",
