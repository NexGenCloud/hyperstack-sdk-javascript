...
var _OrganizationLevelBillingHistoryResponseAttributes = _interopRequireDefault(require("./OrganizationLevelBillingHistoryResponseAttributes"));
var _OrganizationLevelBillingHistoryResponseMetrics = _interopRequireDefault(require("./OrganizationLevelBillingHistoryResponseMetrics"));
...
var OrganizationLevelBillingHistoryResources = /*#__PURE__*/function () {
   ...
   */
  function OrganizationLevelBillingHistoryResources() {
    _classCallCheck(this, OrganizationLevelBillingHistoryResources);
   ...
   */
  return _createClass(OrganizationLevelBillingHistoryResources, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('attributes')) {
          obj['attributes'] = _OrganizationLevelBillingHistoryResponseAttributes["default"].constructFromObject(data['attributes']);
        }
        if (data.hasOwnProperty('metrics')) {
          obj['metrics'] = _OrganizationLevelBillingHistoryResponseMetrics["default"].constructFromObject(data['metrics']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['attributes']) {
        // data not null
        _OrganizationLevelBillingHistoryResponseAttributes["default"].validateJSON(data['attributes']);
      }
      // validate the optional field `metrics`
      if (data['metrics']) {
        // data not null
        _OrganizationLevelBillingHistoryResponseMetrics["default"].validateJSON(data['metrics']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OrganizationLevelBillingHistoryResources;