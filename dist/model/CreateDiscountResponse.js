...
var CreateDiscountResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateDiscountResponse</code>.
  ...
  return _createClass(CreateDiscountResponse, null, [{
    ...
    /**
     * Constructs a <code>CreateDiscountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDiscountResponse} obj Optional instance to populate.
     * @return {module:model/CreateDiscountResponse} The populated <code>CreateDiscountResponse</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDiscountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDiscountResponse</code>.
     */
  }, {
    key: "validateJSON",
