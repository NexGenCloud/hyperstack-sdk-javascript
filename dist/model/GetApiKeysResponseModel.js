 ...
 */
var GetApiKeysResponseModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetApiKeysResponseModel</code>.
   * @alias module:model/GetApiKeysResponseModel
   */
  function GetApiKeysResponseModel() {
    _classCallCheck(this, GetApiKeysResponseModel);
   ...
   */
  return _createClass(GetApiKeysResponseModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('api_keys')) {
          obj['api_keys'] = _ApiClient["default"].convertToType(data['api_keys'], [_ApiKeyFields["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['api_keys']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['api_keys']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _ApiKeyFields["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = GetApiKeysResponseModel;