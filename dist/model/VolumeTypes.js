...
var VolumeTypes = /*#__PURE__*/function () {
  ...
  function VolumeTypes() {
    _classCallCheck(this, VolumeTypes);
   ...
   */
  return _createClass(VolumeTypes, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('volume_types')) {
          obj['volume_types'] = _ApiClient["default"].convertToType(data['volume_types'], ['String']);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = VolumeTypes;