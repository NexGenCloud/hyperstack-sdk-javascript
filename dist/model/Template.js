...
var _TemplateFields = _interopRequireDefault(require("./TemplateFields"));
...
var Template = /*#__PURE__*/function () {
  ...
  return _createClass(Template, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('template')) {
          obj['template'] = _TemplateFields["default"].constructFromObject(data['template']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['template']) {
        // data not null
        _TemplateFields["default"].validateJSON(data['template']);
      }
      return true;
    }
  }]);
