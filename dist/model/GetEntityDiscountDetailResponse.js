 ...
 */
var GetEntityDiscountDetailResponse = /*#__PURE__*/function () {
  /**
  ...
  function GetEntityDiscountDetailResponse() {
    _classCallCheck(this, GetEntityDiscountDetailResponse);
   ...
   */
  return _createClass(GetEntityDiscountDetailResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('organization')) {
          obj['organization'] = _ApiClient["default"].convertToType(data['organization'], [_DiscountPlanFields["default"]]);
        }
        if (data.hasOwnProperty('status')) {
          obj['status'] = _ApiClient["default"].convertToType(data['status'], 'Boolean');
        }
        if (data.hasOwnProperty('virtual-machine')) {
          obj['virtual-machine'] = _ApiClient["default"].convertToType(data['virtual-machine'], [_DiscountPlanFields["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['organization']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['organization']),
          _step;
        try {
      ...
      if (data['virtual-machine']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['virtual-machine']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _DiscountPlanFields["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = GetEntityDiscountDetailResponse;