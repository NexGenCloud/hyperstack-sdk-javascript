...
var _DeploymentFields = _interopRequireDefault(require("./DeploymentFields"));
...
var Deployments = /*#__PURE__*/function () {
   ...
   */
  return _createClass(Deployments, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('deployments')) {
          obj['deployments'] = _ApiClient["default"].convertToType(data['deployments'], [_DeploymentFields["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['deployments']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['deployments']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _DeploymentFields["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = Deployments;