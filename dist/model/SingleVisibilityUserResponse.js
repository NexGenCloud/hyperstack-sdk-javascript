 ...
 */
var SingleVisibilityUserResponse = /*#__PURE__*/function () {
  /**
   ...
   * @param userId {Number} 
   */
  function SingleVisibilityUserResponse(id, stockVisible, userId) {
    _classCallCheck(this, SingleVisibilityUserResponse);
   ...
   */
  return _createClass(SingleVisibilityUserResponse, null, [{
    key: "initialize",
    value: function initialize(obj, id, stockVisible, userId) {
      obj['id'] = id;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('stock_visible')) {
          obj['stock_visible'] = _ApiClient["default"].convertToType(data['stock_visible'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SingleVisibilityUserResponse.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = SingleVisibilityUserResponse;