 ...
 */
var VMUsageRequestPayload = /*#__PURE__*/function () {
  /**
   ...
   */
  function VMUsageRequestPayload(vmIds) {
    _classCallCheck(this, VMUsageRequestPayload);
   ...
   */
  return _createClass(VMUsageRequestPayload, null, [{
    key: "initialize",
    value: function initialize(obj, vmIds) {
      obj['vm_ids'] = vmIds;
    }
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vm_ids')) {
          obj['vm_ids'] = _ApiClient["default"].convertToType(data['vm_ids'], ['Number']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(VMUsageRequestPayload.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = VMUsageRequestPayload;