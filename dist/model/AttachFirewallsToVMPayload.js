...
var AttachFirewallsToVMPayload = /*#__PURE__*/function () {
   ...
   */
  function AttachFirewallsToVMPayload(firewalls) {
    _classCallCheck(this, AttachFirewallsToVMPayload);
   ...
   */
  return _createClass(AttachFirewallsToVMPayload, null, [{
    key: "initialize",
    value: function initialize(obj, firewalls) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('firewalls')) {
          obj['firewalls'] = _ApiClient["default"].convertToType(data['firewalls'], ['Number']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AttachFirewallsToVMPayload.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = AttachFirewallsToVMPayload;