...
var _RbacRoleField = _interopRequireDefault(require("./RbacRoleField"));
...
var OrganizationUserResponseModel = /*#__PURE__*/function () {
   ...
   */
  function OrganizationUserResponseModel() {
    _classCallCheck(this, OrganizationUserResponseModel);
   ...
   */
  return _createClass(OrganizationUserResponseModel, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('joined_at')) {
          obj['joined_at'] = _ApiClient["default"].convertToType(data['joined_at'], 'Date');
        }
        ...
        if (data.hasOwnProperty('rbac_roles')) {
          obj['rbac_roles'] = _ApiClient["default"].convertToType(data['rbac_roles'], [_RbacRoleField["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['rbac_roles']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['rbac_roles']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _RbacRoleField["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = OrganizationUserResponseModel;