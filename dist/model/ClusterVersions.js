...
var ClusterVersions = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ClusterVersions</code>.
   * @alias module:model/ClusterVersions
   */
  function ClusterVersions() {
    _classCallCheck(this, ClusterVersions);
    ClusterVersions.initialize(this);
  }
   ...
   */
  return _createClass(ClusterVersions, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>ClusterVersions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterVersions} obj Optional instance to populate.
     * @return {module:model/ClusterVersions} The populated <code>ClusterVersions</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ClusterVersions();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterVersions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterVersions</code>.
     */
  }, {
    key: "validateJSON",
 ...
 */
ClusterVersions.prototype['message'] = undefined;
