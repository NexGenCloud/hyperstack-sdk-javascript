 ...
 */
var VolumeStatusChangeFields = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>VolumeStatusChangeFields</code>.
   * @alias module:model/VolumeStatusChangeFields
   */
  function VolumeStatusChangeFields() {
    _classCallCheck(this, VolumeStatusChangeFields);
   ...
   */
  return _createClass(VolumeStatusChangeFields, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('current_status')) {
          obj['current_status'] = _ApiClient["default"].convertToType(data['current_status'], 'String');
        }
...
var _default = exports["default"] = VolumeStatusChangeFields;