 ...
 */
var InsertDiscountPlanFields = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>InsertDiscountPlanFields</code>.
   * @alias module:model/InsertDiscountPlanFields
   */
  function InsertDiscountPlanFields() {
    _classCallCheck(this, InsertDiscountPlanFields);
   ...
   */
  return _createClass(InsertDiscountPlanFields, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('customers')) {
          obj['customers'] = _ApiClient["default"].convertToType(data['customers'], [_CustomerFields["default"]]);
        }
      ...
      if (data['customers']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _CustomerFields["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['discount_resources']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _DiscountResourceFields["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = InsertDiscountPlanFields;