 ...
 */
var PricebookResourceObjectResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PricebookResourceObjectResponse</code>.
   * @alias module:model/PricebookResourceObjectResponse
   */
  function PricebookResourceObjectResponse() {
    _classCallCheck(this, PricebookResourceObjectResponse);
   ...
   */
  return _createClass(PricebookResourceObjectResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('host_original_price')) {
          obj['host_original_price'] = _ApiClient["default"].convertToType(data['host_original_price'], 'Number');
        }
        ...
        if (data.hasOwnProperty('nexgen_original_price')) {
          obj['nexgen_original_price'] = _ApiClient["default"].convertToType(data['nexgen_original_price'], 'Number');
        }
...
var _default = exports["default"] = PricebookResourceObjectResponse;