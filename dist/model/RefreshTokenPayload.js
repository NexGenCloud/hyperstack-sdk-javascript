 ...
 */
var RefreshTokenPayload = /*#__PURE__*/function () {
  /**
   ...
   */
  function RefreshTokenPayload(idToken, refreshToken) {
    _classCallCheck(this, RefreshTokenPayload);
   ...
   */
  return _createClass(RefreshTokenPayload, null, [{
    key: "initialize",
    value: function initialize(obj, idToken, refreshToken) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RefreshTokenPayload.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = RefreshTokenPayload;