 ...
 */
var ResourceLevelBillingDetailsVolumeAttributes = /*#__PURE__*/function () {
  /**
   ...
   */
  function ResourceLevelBillingDetailsVolumeAttributes() {
    _classCallCheck(this, ResourceLevelBillingDetailsVolumeAttributes);
   ...
   */
  return _createClass(ResourceLevelBillingDetailsVolumeAttributes, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('subresource_amount')) {
          obj['subresource_amount'] = _ApiClient["default"].convertToType(data['subresource_amount'], 'Number');
        }
        if (data.hasOwnProperty('subresource_type')) {
          obj['subresource_type'] = _ApiClient["default"].convertToType(data['subresource_type'], 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = ResourceLevelBillingDetailsVolumeAttributes;